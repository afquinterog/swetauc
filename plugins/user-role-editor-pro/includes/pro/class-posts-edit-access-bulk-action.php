...
<?php
        ...
        wp_localize_script( 'ure-bulk-edit-access', 'ure_bulk_edit_access_data', array(
            ...
            'action_title' => esc_html__('Edit Access', 'ure'),
            'dialog_title' => esc_html(__('Editor Restrictions Helper', 'ure')),
            'apply' => esc_html(__('Apply', 'ure')),
            'provide_user_ids' => esc_html(__('Provide list of users ID', 'ure'))
              ));
