...
?>        
        <h3><?php _e('Themes available for activation', 'ure'); ?></h3>
   ...
   /**
    ...
    public function admin_load_js($hook_suffix) {
        ...
        if ($hook_suffix === 'user-edit.php') {
            ...
            wp_register_script('ure-pro-user-profile-themes', plugins_url('/js/pro/ure-pro-user-profile-themes.js', URE_PLUGIN_FULL_PATH));
            wp_enqueue_script('ure-pro-user-profile-themes');
            wp_localize_script('ure-pro-user-profile-themes', 'ure_pro_data_themes', array(
                'wp_nonce' => wp_create_nonce('user-role-editor'),
                'edit_allowed_themes' => __('Edit Themes List', 'ure'),
                'edit_allowed_themes_title' => __('Themes list you allow this user to activate/deactivate', 'ure'),
                'save_themes_list' => __('Save', 'ure'),
                'close' => __('Close', 'ure'),
            ));
        }
    }
